...
def test_quantum_demo():
    print("[INIT] Initializing Phoenix Quantum Simulator...")
    time.sleep(0.5)
    ...
    shape = [8]
    print(f"[MEM] Allocating Quantum State Vector of size {shape} (8 amplitudes)...")
    ...
    try:
        ...
        print(f"[OK] Quantum Memory Allocated at: {q_data}")
        ...
        print("\n[HYBRID] Demonstrating Hybrid Quantum-Classical Workflow...")
        ...
        print(f"[ERROR] Error during Quantum Simulation: {e}")
